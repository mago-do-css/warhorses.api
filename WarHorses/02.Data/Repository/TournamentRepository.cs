...
namespace _02.Data.Repository
{
    public class TournamentRepository : ITournamentRepository
    {
        ...
        {
            var result = await _context.Tournaments.FirstOrDefaultAsync(t => t.Id == entity.Id);

            if(result == null) throw new Exception("Torneio nao encontrado!");
